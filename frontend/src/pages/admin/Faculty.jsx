  ...
  return (
    ...
    >
      <div style={{ ...M.modal, maxWidth: 420 }}>
        <div style={M.header}>
          <h2 style={{ ...M.title, color: "#dc2626" }}>Delete Researcher</h2>
        ...
        <div style={M.body}>
          <p style={{ margin: "0 0 12px", fontSize: 14, color: "#374151" }}>
            ...
            <strong>{researcher.name}</strong>? This action cannot be undone.
          </p>
...
export default function ResearcherManagement() {
  ...
  const getDepartment = (item) => {
    return item.department || item.department_center?.name || "—";
  };

  const getProgram = (item) => {
    return item.program || item.course || item.program_name || "—";
  };
  ...
  useEffect(() => {
    ...
    setFiltered(
      researchers.filter((item) => {
        ...
        const program = getProgram(item).toLowerCase();
          ...
          <div style={{ padding: "24px", flex: 1 }}>
            ...
            >
              <h3 style={{ margin: 0, fontSize: 13, color: "#6b7280" }}>
                Manage researcher profiles and project proponents
              </h3>
            ...
            >
              ...
              {loading ? (
                ...
                <div style={{ padding: "48px 24px", textAlign: "center" }}>
                  ...
                  >
                    Click <strong>Add Researcher</strong> to get started.
                  </p>
                </div>
              ) : (
                <>
